				...
				<div class="profile-sidebar" style="width: 250px;">
					...
					<div class="portlet light profile-sidebar-portlet">
						...
						<div class="profile-userpic">
							{!! Html::image('assets/img/profile_user.jpg', 'profile_user', array('class' => 'img-responsive')) !!}
						</div>
						<!-- END SIDEBAR USERPIC -->
						<!-- SIDEBAR USER TITLE -->
							...
							<div class="portlet light ">
								...
								<div class="portlet-body">
									...
									<div class="table-scrollable table-scrollable-borderless">
										...
										<tr>
											<td class="fit">
												{!! Html::image('assets/img/avatar4.jpg', 'avatar5', array('user-pic')) !!}
											</td>
											<td>
										...
										<tr>
											<td class="fit">
												{!! Html::image('assets/img/avatar5.jpg', 'avatar5', array('user-pic')) !!}
											</td>
											<td>
										...
										<tr>
											<td class="fit">
												{!! Html::image('assets/img/avatar6.jpg', 'avatar6', array('user-pic')) !!}
											</td>
											<td>
										...
										<tr>
											<td class="fit">
												{!! Html::image('assets/img/avatar7.jpg', 'avatar7', array('user-pic')) !!}
											</td>
											<td>
